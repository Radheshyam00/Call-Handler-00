...
def validate_number(mobile_number):
    ...
    url = f"https://www.numlookupapi.com/api/v1/validate/{mobile_number}?apikey={NUMLOOKUP_API_KEY}"
...
def get_phone_list(list_name):
    """Retrieve phone numbers from a specific list in MongoDB (whitelist, blacklist, blocked)."""
...
page = st.sidebar.radio("Go to", ["Number Checker", "Filter System", "Manage Lists"])
